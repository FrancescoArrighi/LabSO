...
#define MSG_OVERRIDE_WINST
#define MSG_OVERRIDE_BULBST
#define MSG_OVERRIDE_FRIDGEST
#define MSG_OVERRIDE_FRIDGEINT
#define MSG_OVERRIDE_FRIDGEDLY
#define MSG_OVERRIDE_FRIDGETERM
