...
int equal_window(msgbuf * msg1, msgbuf * msg2){
  ...
  if(strcmp(buf1[MSG_WINDOW_INF_STATO], buf2[MSG_WINDOW_INF_STATO]) == 0 && (strcmp(buf1[MSG_WINDOW_INF_NOME], buf2[MSG_WINDOW_INF_NOME]) == 0)) {
